...
Object.setPrototypeOf(createVec4, Vec4);
const vec4 = createVec4;
                    ...
                    for (let a = 0; a < sn.length; ++a)
                        for (let b = 0; b < sn.length; ++b) {
                            ...
                            Object.defineProperty(prototype, key, {
                                get() {
                                    return new Vec2(a < 2 ? a : this[a - 2], b < 2 ? b : this[b - 2]);
                                }
                            });
                        }
                    break;
                    ...
                    for (let a = 0; a < sn.length; ++a)
                        for (let b = 0; b < sn.length; ++b)
                            for (let c = 0; c < sn.length; ++c) {
                                ...
                                Object.defineProperty(prototype, key, {
                                    get() {
                                        return new Vec3(a < 2 ? a : this[a - 2], b < 2 ? b : this[b - 2], c < 2 ? c : this[c - 2]);
                                    }
                                });
                            }
                    break;
                        ...
                        for (let b = 0; b < sn.length; ++b)
                            for (let c = 0; c < sn.length; ++c)
                                for (let d = 0; d < sn.length; ++d) {
                                    ...
                                    Object.defineProperty(prototype, key, {
                                        get() {
                                            return new Vec4(a < 2 ? a : this[a - 2], b < 2 ? b : this[b - 2], c < 2 ? c : this[c - 2], d < 2 ? d : this[d - 2]);
                                        }
                                    });
                                }
                    break;
...
Object.setPrototypeOf(createVec2, Vec2);
const vec2 = createVec2;
...
class Mat4 extends Float32Array {
     ...
     * @returns {Vec3} out
     */
    static project(obj, model, proj, viewport, out = new Vec3()) {
     ...
     */
    static unProject(win, model, proj, viewport, out = new Vec3()) {
...
class Quat extends Float32Array {
     ...
     * @returns {Quat} out
     */
    static fromAxisAngle(axis, rad, out = quat()) {
        rad *= 0.5;
     ...
     * @returns {Quat} out
     */
    static fromEuler(x, y, z, order = index.ANGLE_ORDER, out = quat()) {
     ...
     * @returns {Quat} out
     */
    static rotationTo(a, b, out = quat()) {
     ...
     * @returns {Quat} out
     */
    static sqlerp(a, b, c, d, t, out = quat()) {
     ...
     * @returns {Quat} out
     */
    static setAxes(view, right, up, out = quat()) {
...
export { Mat2, Mat2x3, Mat3, Mat4, Quat, Quat2, Vec2, Vec3, Vec4, abs, clamp, clamp01, index as default, deg, degrees, fract, lerp, mat2, mat2d, mat2x2, mat2x3, mat3, mat3x3, mat4, mat4x4, mix, quat, quat2, rad, radians, round, saturate, sign, smoothstep, step, toDegrees, toRadians, vec2, vec3, vec4 };
