...
declare class Vec4 extends Float32Array {
    ...
    invDiv(b: Vec4 | number, out?: Vec4): Vec4;
    /**
     ...
     * @param {Vec4 | number} min the minimum bound
     * @param {Vec4 | number} max the maximum bound
     * @param {Vec4} out the receiving vector
     * @returns {Vec4} out
     */
    static clamp(v: Vec4, min: Vec4 | number, max: Vec4 | number, out?: Vec4): Vec4;
    /**
     * Performs a linear interpolation between two vec4's.
     *
     * @param {Vec4} a the first operand
     * @param {Vec4} b the second operand
     * @param {Vec4 | number} t interpolation amount
     * @param {Vec4} out the receiving vector
     * @returns {Vec4} out
     */
    static mix(a: Vec4, b: Vec4, t: Vec4 | number, out?: Vec4): Vec4;
    /**
     * Performs Hermite interpolation between two values.
     *
     * @param {Vec4 | number} edge0 the lower edge
     * @param {Vec4 | number} edge1 the upper edge
     * @param {Vec4} v the source vector
     * @param {Vec4} out the receiving vector
     * @returns {Vec4} out
     */
    static smoothstep(edge0: Vec4 | number, edge1: Vec4 | number, v: Vec4, out?: Vec4): Vec4;
    /**
     ...
     * @returns {Vec4} out
     */
    clamp(min: Vec4 | number, max: Vec4 | number, out?: Vec4): Vec4;
    /**
     ...
     * @returns {Vec4} out
     */
    mix(b: Vec4, t: Vec4 | number, out?: Vec4): Vec4;
    /**
     * Returns 0.0 if this < edge, otherwise 1.0 for each component.
     *
     * @param {Vec4 | number} edge the edge value
     * @param {Vec4} out the receiving vector
     * @returns {Vec4} out
     */
    step(edge: Vec4 | number, out?: Vec4): Vec4;
    /**
     * Performs Hermite interpolation between two values.
     *
     * @param {Vec4 | number} edge0 the lower edge
     ...
     * @returns {Vec4} out
     */
    smoothstep(edge0: Vec4 | number, edge1: Vec4 | number, out?: Vec4): Vec4;
    /**
...
interface Vec4 {
    add: (b: Vec4 | number, out?: Vec4) => Vec4;
    sub: (b: Vec4 | number, out?: Vec4) => Vec4;
    subtract: (b: Vec4 | number, out?: Vec4) => Vec4;
    mul: (b: Vec4 | number, out?: Vec4) => Vec4;
    scale: (b: Vec4 | number, out?: Vec4) => Vec4;
    multiply: (b: Vec4 | number, out?: Vec4) => Vec4;
    times: (b: Vec4 | number, out?: Vec4) => Vec4;
    divide: (b: Vec4 | number, out?: Vec4) => Vec4;
    neg: (out?: Vec4) => Vec4;
    unaryMinus: (out?: Vec4) => Vec4;
    sqrLen: () => number;
    str: () => string;
...
declare const createVec4: (...args: (number | Float32Array)[]) => Vec4;
declare const vec4: typeof createVec4 & typeof Vec4;
...
declare class Vec3 extends Float32Array {
     ...
     * @returns {Vec3} out
     */
    static clamp(v: Vec3, min: Vec3 | number, max: Vec3 | number, out?: Vec3): Vec3;
    /**
     ...
     * @returns {Vec3} out
     */
    static mix(a: Vec3, b: Vec3, t: Vec3 | number, out?: Vec3): Vec3;
    /**
...
declare const createVec3: (...args: (number | Float32Array)[]) => Vec3;
declare const vec3: typeof createVec3 & typeof Vec3;
...
declare const createMat2: (...args: (number | Float32Array)[]) => Mat2;
declare const mat2: typeof createMat2 & typeof Mat2;
declare const mat2x2: ((...args: (number | Float32Array)[]) => Mat2) & typeof Mat2;
...
declare class Vec2 extends Float32Array {
     ...
     */
    static clamp(v: Vec2, min: Vec2 | number, max: Vec2 | number, out?: Vec2): Vec2;
    /**
     ...
     * @returns {Vec2} a new interpolated Vec2
     */
    static mix(a: Vec2, b: Vec2, t: Vec2 | number, out?: Vec2): Vec2;
    /**
     ...
     */
    static smoothstep(edge0: Vec2 | number, edge1: Vec2 | number, v: Vec2, out?: Vec2): Vec2;
    /**
...
interface Vec2 {
    add: (b: Vec2 | number, out?: Vec2) => Vec2;
    sub: (b: Vec2 | number, out?: Vec2) => Vec2;
    subtract: (b: Vec2 | number, out?: Vec2) => Vec2;
    mul: (b: Vec2 | number, out?: Vec2) => Vec2;
    multiply: (b: Vec2 | number, out?: Vec2) => Vec2;
    scale: (b: Vec2 | number, out?: Vec2) => Vec2;
    times: (b: Vec2 | number, out?: Vec2) => Vec2;
    divide: (b: Vec2 | number, out?: Vec2) => Vec2;
    neg: (out?: Vec2) => Vec2;
    unaryMinus: (out?: Vec2) => Vec2;
    sqrLen: () => number;
    str: () => string;
    lerpV: (b: Vec2, t: Vec2 | number, out?: Vec2) => Vec2;
    transformMat2x2: (m: Mat2, out?: Vec2) => Vec2;
...
declare const createVec2: (...args: (number | Float32Array)[]) => Vec2;
declare const vec2: typeof createVec2 & typeof Vec2;
...
export { Mat2, Mat2x3, Mat3, Mat4, Quat, Quat2, Vec2, Vec3, Vec4, abs, clamp, clamp01, _default as default, deg, degrees, fract, lerp, mat2, mat2d, mat2x2, mat2x3, mat3, mat3x3, mat4, mat4x4, mix, quat, quat2, rad, radians, round, saturate, sign, smoothstep, step, toDegrees, toRadians, vec2, vec3, vec4 };
